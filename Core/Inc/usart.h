...
#define USARTx_TX_CLK_ENABLE() __HAL_RCC_GPIOC_CLK_ENABLE() //TX引脚
#define USARTx_RX_CLK_ENABLE() __HAL_RCC_GPIOC_CLK_ENABLE() //RX引脚

#define USARTx_TX_CLK_DISABLE() __HAL_RCC_GPIOC_CLK_DISABLE() //TX引脚
#define USARTx_RX_CLK_DISABLE() __HAL_RCC_GPIOC_CLK_DISABLE() //RX引脚


#define USARTx_GPIO_AF GPIO_AF8_USART6
#define USARTx_TX_PORT GPIOC
#define USARTx_RX_PORT GPIOC
...
#define USARTx3 USART6                 
#define USARTx3_CLK_ENABLE()   __HAL_RCC_USART6_CLK_ENABLE()
// #define USARTx3_REMAP_CLK_ENABLE()   __HAL_AFIO_REMAP_USART3_ENABLE() //完全重映射引脚
#define USARTx3_TX_CLK_ENABLE() __HAL_RCC_GPIOC_CLK_ENABLE() //TX引脚
#define USARTx3_RX_CLK_ENABLE() __HAL_RCC_GPIOC_CLK_ENABLE() //RX引脚

#define USARTx3_TX_PORT GPIOC
#define USARTx3_RX_PORT GPIOC
#define USARTx3_TX_PIN GPIO_PIN_6
#define USARTx3_RX_PIN GPIO_PIN_7

#define USARTx3_IRQn USART6_IRQn
