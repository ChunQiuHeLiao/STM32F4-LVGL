...
void setup_scr_screen_music(lv_ui *ui)
{
    ...
    lv_obj_set_size(ui->screen_music_cont_main, 240, 230);
    ...
    lv_obj_set_style_bg_color(ui->screen_music_cont_main, lv_color_hex(0xffffff), LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->screen_music_cont_play_area, 0, 260);
