...
void init_scr_del_flag(lv_ui *ui)
{
    ...
    ui->screen_setting_sys_update_del = true;
    ui->screen_calendar_del = true;
    ui->screen_set_waln_del = true;
    ui->screen_vedio_del = true;
    ui->screen_vedio_show_del = true;
    ui->screen_album_del = true;
    ui->screen_album_show_del = true;
    ui->screen_music_del = true;
    ui->screen_fe_del = true;
...
void ui_load_scr_no_animation(lv_ui* ui, lv_obj_t** new_scr, bool new_scr_del, bool* old_scr_del, ui_setup_scr_t setup_scr)
{
    ...
    ui_load_scr_animation(ui, new_scr, new_scr_del, old_scr_del, setup_scr, LV_SCR_LOAD_ANIM_NONE, 0, 0, true, true);
}
