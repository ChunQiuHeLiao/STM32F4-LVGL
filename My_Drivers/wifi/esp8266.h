...
#define ESP8266_GPIO_EN_CLK_ENABLE() __HAL_RCC_GPIOB_CLK_ENABLE() //高电平有效
#define ESP8266_GPIO_EN_PORT GPIOB
#define ESP8266_GPIO_EN_PIN GPIO_PIN_8

#define ESP8266_GPIO_RST_CLK_ENABLE() __HAL_RCC_GPIOB_CLK_ENABLE() //复位高低高即可复位完成
#define ESP8266_GPIO_RST_PORT GPIOB
#define ESP8266_GPIO_RST_PIN GPIO_PIN_9
